...
pub const Lowering = struct {
    ...
    pub const tagOnlyChannelFor = lower_error.tagOnlyChannelFor;
    pub const tagOnlyChannelOf = lower_error.tagOnlyChannelOf;
    pub const lowerTagOf = lower_error.lowerTagOf;
