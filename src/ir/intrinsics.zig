...
pub const entries = [_]Entry{
    ...
    .{ .id = .structFieldCount, .module = core, .name = "structFieldCount", .mode = .lower, .arity = 1, .ret = .i64 },
    .{ .id = .variantCount, .module = core, .name = "variantCount", .mode = .lower, .arity = 1, .ret = .i64 },
    .{ .id = .structFieldName, .module = core, .name = "structFieldName", .mode = .lower, .arity = 2, .ret = .string },
    .{ .id = .variantName, .module = core, .name = "variantName", .mode = .lower, .arity = 2, .ret = .string },
    .{ .id = .structFieldType, .module = core, .name = "structFieldType", .mode = .lower, .arity = 2, .ret = .type_value },
    .{ .id = .structFieldOffset, .module = core, .name = "structFieldOffset", .mode = .lower, .arity = 2, .ret = .i64 },
    .{ .id = .variantType, .module = core, .name = "variantType", .mode = .lower, .arity = 2, .ret = .type_value },
    ...
    .{ .id = .variantValue, .module = core, .name = "variantValue", .mode = .lower, .arity = 2, .ret = .i64 },
