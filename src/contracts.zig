...
pub const entries = [_]Contract{
    ...
    .{ .name = "@addLinkFlag", .module = "modules/build.sx" },
    .{ .name = "@addFramework", .module = "modules/build.sx" },
    .{ .name = "@setOutputPath", .module = "modules/build.sx" },
    .{ .name = "@setWasmShell", .module = "modules/build.sx" },
    .{ .name = "@addAssetDir", .module = "modules/build.sx" },
    .{ .name = "@assetDirCount", .module = "modules/build.sx" },
    .{ .name = "@assetDirSrcAt", .module = "modules/build.sx" },
    .{ .name = "@assetDirDestAt", .module = "modules/build.sx" },
    .{ .name = "@setPostLinkModule", .module = "modules/build.sx" },
    .{ .name = "@binaryPath", .module = "modules/build.sx" },
    .{ .name = "@setBundlePath", .module = "modules/build.sx" },
    .{ .name = "@setBundleId", .module = "modules/build.sx" },
    .{ .name = "@setCodesignIdentity", .module = "modules/build.sx" },
    .{ .name = "@setProvisioningProfile", .module = "modules/build.sx" },
    .{ .name = "@bundlePath", .module = "modules/build.sx" },
    .{ .name = "@bundleId", .module = "modules/build.sx" },
    .{ .name = "@codesignIdentity", .module = "modules/build.sx" },
    .{ .name = "@provisioningProfile", .module = "modules/build.sx" },
    .{ .name = "@targetTriple", .module = "modules/build.sx" },
    .{ .name = "@isMacos", .module = "modules/build.sx" },
    .{ .name = "@isIos", .module = "modules/build.sx" },
    .{ .name = "@isIosDevice", .module = "modules/build.sx" },
    .{ .name = "@isIosSimulator", .module = "modules/build.sx" },
    .{ .name = "@isAndroid", .module = "modules/build.sx" },
    .{ .name = "@frameworkCount", .module = "modules/build.sx" },
    .{ .name = "@frameworkAt", .module = "modules/build.sx" },
    .{ .name = "@frameworkPathCount", .module = "modules/build.sx" },
    .{ .name = "@frameworkPathAt", .module = "modules/build.sx" },
    .{ .name = "@setManifestPath", .module = "modules/build.sx" },
    .{ .name = "@setKeystorePath", .module = "modules/build.sx" },
    .{ .name = "@manifestPath", .module = "modules/build.sx" },
    .{ .name = "@keystorePath", .module = "modules/build.sx" },
    .{ .name = "@jniMainCount", .module = "modules/build.sx" },
    .{ .name = "@jniMainRuntimePathAt", .module = "modules/build.sx" },
    .{ .name = "@jniMainJavaSourceAt", .module = "modules/build.sx" },
