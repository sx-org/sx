...
pub const entries = [_]Contract{
    ...
    .{ .name = "@pointeeType", .module = "modules/std/core.sx" },
    .{ .name = "@isFlags", .module = "modules/std/core.sx" },
    .{ .name = "@anyElement", .module = "modules/std/core.sx" },
    .{ .name = "@rawAnyData", .module = "modules/std/core.sx" },
    .{ .name = "@rawMakeAny", .module = "modules/std/core.sx" },
    .{ .name = "@atomicLoad", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicStore", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchAdd", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchSub", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchAnd", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchOr", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchXor", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchMin", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFetchMax", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicSwap", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicFence", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicCmpxchg", .module = "modules/std/atomic.sx" },
    .{ .name = "@atomicCmpxchgWeak", .module = "modules/std/atomic.sx" },
    .{ .name = "@rawIntern", .module = "modules/std/core.sx" },
    .{ .name = "@rawTextOf", .module = "modules/std/core.sx" },
    .{ .name = "@rawFindType", .module = "modules/std/core.sx" },
    .{ .name = "@rawTypeKind", .module = "modules/std/core.sx" },
    .{ .name = "@rawTypeName", .module = "modules/std/core.sx" },
    .{ .name = "@rawFieldCount", .module = "modules/std/core.sx" },
    .{ .name = "@rawFieldName", .module = "modules/std/core.sx" },
    .{ .name = "@rawFieldType", .module = "modules/std/core.sx" },
    .{ .name = "@rawVariantValue", .module = "modules/std/core.sx" },
    .{ .name = "@rawPointerTo", .module = "modules/std/core.sx" },
    .{ .name = "@rawDeclareType", .module = "modules/std/meta.sx" },
    .{ .name = "@rawRegisterType", .module = "modules/std/meta.sx" },
    .{ .name = "@cObjectPaths", .module = "modules/compiler.sx" },
    .{ .name = "@linkLibraries", .module = "modules/compiler.sx" },
    .{ .name = "@emitObject", .module = "modules/compiler.sx" },
    .{ .name = "@link", .module = "modules/compiler.sx" },
    .{ .name = "@buildOutput", .module = "modules/compiler.sx" },
    .{ .name = "@buildTarget", .module = "modules/compiler.sx" },
    .{ .name = "@buildFrameworks", .module = "modules/compiler.sx" },
    .{ .name = "@buildFlags", .module = "modules/compiler.sx" },
    .{ .name = "@BuildOptions", .module = "modules/build.sx" },
    .{ .name = "@buildOptions", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.addLinkFlag", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.addFramework", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setOutputPath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setWasmShell", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.addAssetDir", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.assetDirCount", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.assetDirSrcAt", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.assetDirDestAt", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setPostLinkModule", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.binaryPath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setBundlePath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setBundleId", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setCodesignIdentity", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setProvisioningProfile", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.bundlePath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.bundleId", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.codesignIdentity", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.provisioningProfile", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.targetTriple", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.isMacos", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.isIos", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.isIosDevice", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.isIosSimulator", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.isAndroid", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.frameworkCount", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.frameworkAt", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.frameworkPathCount", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.frameworkPathAt", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setManifestPath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.setKeystorePath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.manifestPath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.keystorePath", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.jniMainCount", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.jniMainRuntimePathAt", .module = "modules/build.sx" },
    .{ .name = "@BuildOptions.jniMainJavaSourceAt", .module = "modules/build.sx" },
    .{ .name = "@onBuild", .module = "modules/build.sx" },
    ...
    .{ .name = "@assert", .module = "modules/std/core.sx" },
