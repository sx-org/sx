...
pub const entries = [_]Contract{
    ...
    // The build state: the compiler snapshots and materializes the instance
    // by this field order, and the driver reads / writes fields by name.
    .{
        .name = "@BuildOptions",
        .module = "modules/build.sx",
        .fields = &.{
            .{ .name = "linkFlags", .type_name = "List(string)" },
            .{ .name = "frameworks", .type_name = "List(string)" },
            .{ .name = "assetDirs", .type_name = "List(AssetDir)" },
            .{ .name = "outputPath", .type_name = "string" },
            .{ .name = "wasmShell", .type_name = "string" },
            .{ .name = "binaryPath", .type_name = "string" },
            .{ .name = "bundlePath", .type_name = "string" },
            .{ .name = "bundleId", .type_name = "string" },
            .{ .name = "codesignIdentity", .type_name = "string" },
            .{ .name = "provisioningProfile", .type_name = "string" },
            .{ .name = "targetTriple", .type_name = "string" },
            .{ .name = "targetFrameworks", .type_name = "List(string)" },
            .{ .name = "targetFrameworkPaths", .type_name = "List(string)" },
            .{ .name = "manifestPath", .type_name = "string" },
            .{ .name = "keystorePath", .type_name = "string" },
            .{ .name = "jniMainRuntimePaths", .type_name = "List(string)" },
            .{ .name = "jniMainJavaSources", .type_name = "List(string)" },
        },
    },
