pub const Tag = enum(u8) {
    ...
    /// The token-class vocabulary consumers dispatch on instead of per-tag
    /// switches. `at_identifier` sits with the type keywords: a compiler-formed
    /// `@Name` is only ever a type spelling.
    ...
    pub fn family(tag: Tag) Family {
        return switch (tag) {
            ...
            .identifier
            => .identifier,
            .at_identifier, .kw_f32, .kw_f64, .kw_Type, .kw_Self
            => .type_keyword,
            .kw_if, .kw_else, .kw_then, .kw_true, .kw_false, .kw_enum, .kw_error, .kw_raise,
            .kw_try, .kw_catch, .kw_onfail, .kw_case, .kw_break, .kw_continue, .kw_while, .kw_for,
            .kw_return, .kw_defer, .kw_struct, .kw_union, .kw_xx, .kw_and, .kw_or, .kw_null,
            .kw_push, .kw_ufcs, .kw_in, .kw_protocol, .kw_impl, .kw_inline, .kw_abi, .kw_extern,
            .kw_export, .kw_asm, .kw_intrinsic, .kw_private
            => .keyword,
            .hash_run, .hash_error, .hash_import, .hash_insert, .hash_library, .hash_framework,
            .hash_using, .hash_include, .hash_source, .hash_define, .hash_flags, .hash_identity,
            .hash_expand, .hash_objc_call, .hash_jni_call, .hash_jni_static_call, .hash_jni_class,
            .hash_jni_interface, .hash_objc_class, .hash_objc_protocol, .hash_swift_class,
            .hash_swift_struct, .hash_swift_protocol, .hash_extends, .hash_implements,
            .hash_jni_method_descriptor, .hash_selector, .hash_property, .hash_get, .hash_set,
            .hash_jni_env, .hash_jni_main, .hash_context_extend
            => .directive,
            .plus, .minus, .star, .slash, .equal, .equal_equal, .bang, .bang_equal, .less,
            .less_equal, .greater, .greater_equal, .plus_equal, .minus_equal, .star_equal,
            .slash_equal, .percent, .percent_equal, .ampersand, .ampersand_equal, .pipe,
            .pipe_equal, .pipe_arrow, .caret, .caret_equal, .question, .question_question,
            .question_dot, .tilde, .less_less, .less_less_equal, .greater_greater,
            .greater_greater_equal, .arrow, .fat_arrow, .colon_colon, .colon_equal, .triple_minus,
            .minus_minus
            => .operator,
            .colon, .semicolon, .comma, .dot, .dot_dot, .dot_dot_eq, .dot_dot_lt, .lt_dot_dot,
            .lt_dot_dot_eq, .lt_dot_dot_lt, .eq_dot_dot, .eq_dot_dot_eq, .eq_dot_dot_lt, .dollar,
    ...
    pub fn isKeyword(tag: Tag) bool {
        return switch (tag) {
            .kw_if, .kw_else, .kw_then, .kw_true, .kw_false, .kw_enum, .kw_error, .kw_raise,
            .kw_try, .kw_catch, .kw_onfail, .kw_case, .kw_break, .kw_continue, .kw_while, .kw_for,
            .kw_return, .kw_defer, .kw_f32, .kw_f64, .kw_struct, .kw_union, .kw_xx, .kw_and,
            .kw_or, .kw_Type, .kw_null, .kw_push, .kw_ufcs, .kw_in, .kw_protocol, .kw_impl,
            ...
            .identifier, .at_identifier, .colon, .colon_colon, .colon_equal, .semicolon, .comma,
            ...
            .equal, .equal_equal, .bang, .bang_equal, .less, .less_equal, .greater, .greater_equal,
            .plus_equal, .minus_equal, .star_equal, .slash_equal, .percent, .percent_equal,
            .ampersand, .ampersand_equal, .pipe, .pipe_equal, .pipe_arrow, .caret, .caret_equal,
            .question, .question_question, .question_dot, .tilde, .less_less, .less_less_equal,
            .greater_greater, .greater_greater_equal, .l_paren, .r_paren, .l_brace, .r_brace,
            .l_bracket, .r_bracket, .arrow, .fat_arrow, .hash_run, .hash_error, .hash_import,
            .hash_insert, .hash_library, .hash_framework, .hash_using, .hash_include, .hash_source,
            .hash_define, .hash_flags, .hash_identity, .hash_expand, .hash_objc_call,
