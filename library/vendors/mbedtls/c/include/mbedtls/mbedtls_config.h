 ...
 */
//#define MBEDTLS_FS_IO   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SELF_TEST   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SSL_DTLS_CONNECTION_ID   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SSL_PROTO_DTLS   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SSL_DTLS_ANTI_REPLAY   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SSL_DTLS_HELLO_VERIFY   /* sx: disabled */
 ...
 */
//#define MBEDTLS_SSL_DTLS_CLIENT_PORT_REUSE   /* sx: disabled */
 ...
 */
//#define MBEDTLS_DEBUG_C   /* sx: disabled */
 ...
 */
//#define MBEDTLS_NET_C   /* sx: disabled */
 ...
 */
//#define MBEDTLS_PSA_CRYPTO_STORAGE_C   /* sx: disabled */
 ...
 */
//#define MBEDTLS_PSA_ITS_FILE_C   /* sx: disabled */
 ...
 */
#define MBEDTLS_SSL_CLI_C   /* sx: enabled — the client sources (ssl_client.c,
                            * ssl_tls1{2,3}_client.c) are already in the build
                            * list, so this only ACTIVATES them; for a server-only
                            * deployment the client code is unreferenced and the
                            * linker strips it. Enabling lets the loopback TLS
                            * test (T5) run a self-contained in-process client —
                            * no external openssl, corpus/sandbox-friendly. */
 ...
 */
//#define MBEDTLS_TIMING_C   /* sx: disabled */
